...
> = {
  simulations: {
    title: 'Лимит проверок материала исчерпан',
    subtitle: 'Бесплатный план уже показал первые слабые места. Для нового разбора нужен Defense Brief или PRO.',
  },
  documents: {
    title: 'Лимит материалов исчерпан',
    subtitle: 'Бесплатный план ограничивает библиотеку материалов для подготовки к встречам.',
  },
  personas: {
    title: 'Оппонент доступен в PRO',
    subtitle: 'Этот оппонент открыт только в плане PRO.',
  },
  pdf: {
    title: 'PDF Defense Brief — только в PRO',
    subtitle: 'Экспорт рабочего brief перед встречей доступен в плане PRO.',
  },
};

const PRO_FEATURES = [
  'Безлимитные проверки материала каждый месяц',
  'Расширенная библиотека материалов встречи',
  'Все оппоненты для CFO, клиента, инвестора и board',
  'PDF-экспорт Defense Brief',
