    ...
    return (
        <div className="pb-10 pt-4 sm:pt-8 w-full max-w-5xl mx-auto px-6 lg:px-10 overflow-hidden">
            <div className="flex flex-col gap-6 mb-10 sm:mb-14">
                <div>
                    <h1 className="font-syne text-2xl sm:text-3xl font-bold text-[var(--text-main)] leading-tight tracking-tight m-0 mb-4">
                        Настройка симуляции
                    </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="font-inter font-medium text-[var(--text-main)] truncate mb-1">
                                    Без документа
                                </div>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="font-inter font-medium text-[var(--text-main)] truncate">
                                                {doc.title}
                                            </span>
                                        </div>
                                        <div className="font-inter text-xs text-[var(--text-muted)] line-clamp-1">
