    ...
    <div className="flex flex-col w-full min-h-screen">
      <div className="container-custom py-10 md:py-16">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start mb-12">
          <div className="flex-1 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-2xl bg-[var(--accent-blue)] text-white">
                <Icon size={24} />
              </div>
              <div className="editorial-kicker text-[var(--accent-blue)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-xl font-bold font-syne flex items-center gap-2">
                        <StickyNote size={20} className="text-[var(--accent-blue)]" />
                        Заметки проекта
                      </h3>
                    </div>
                    ...
                    {project.documents.map((doc) => (
                      <div key={doc.id} className="panel p-4 flex items-center justify-between hover:bg-[var(--bg-surface-hover)] transition-colors">
                        <div className="flex items-center gap-4">
                          <div className="p-2 rounded-lg bg-white/5 text-[var(--accent-blue)]">
                            <FileText size={18} />
                          </div>
                          <div className="flex flex-col">
                    ...
                    {project.simulations.map((sim) => {
                      ...
                      return (
                        <div key={sim.id} className="panel p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-[var(--bg-surface-hover)] transition-colors">
                          <div className="flex items-center gap-4">
                            <div className="p-3 rounded-xl bg-white/5 text-[var(--accent-blue)]">
                              <SimIcon size={20} />
                            </div>
                            <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-6">
            <div className="panel p-6 bg-gradient-to-br from-[var(--accent-blue)]/10 to-transparent border-[var(--accent-blue)]/20">
              ...
              <ul className="flex flex-col gap-4">
                 {[
                   ...
                   <li key={i} className="flex gap-3 text-xs leading-relaxed text-slate-300">
                      <span className="text-[var(--accent-blue)] font-mono shrink-0">0{i+1}.</span>
                      {tip}
                   </li>
                 ))}
              </ul>
