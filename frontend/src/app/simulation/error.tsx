  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-white px-4">
      <section className="w-full max-w-xl border border-neutral-950 bg-white p-6 shadow-[8px_8px_0_rgba(232,96,10,0.18)]">
        <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-[#E8600A]">stress-test error</div>
        <h1 className="mt-4 font-inter text-2xl font-black text-neutral-950">Стресс-тест остановился</h1>
        <p className="mt-3 font-inter text-sm leading-6 text-neutral-600">Материал можно попробовать восстановить. Если ошибка повторится, начните новую проверку.</p>
