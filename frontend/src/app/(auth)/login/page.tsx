  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-neutral-500 text-sm">Войдите, чтобы продолжить подготовку</p>
      </div>

      <a href={signInHref} className="w-full bg-[#171717] hover:bg-black text-white font-medium rounded-none py-3.5 text-xs font-semibold h-11 transition-colors flex items-center justify-center">
        Войти через PeakTalk
      </a>
      <p className="mt-4 text-center text-xs text-neutral-500">Email, пароль и восстановление защищены Logto.</p>
