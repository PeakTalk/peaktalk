  ...
  const steps = [
    {
      ...
      desc: 'Не тему, не область — конкретный файл. Питч-дек, роадмап, финансовую модель, стратегию. PeakTalk разбирает именно его: аргументы, данные, структуру. Вопросы на сессии будут по вашему материалу — не по теме в целом.',
      direction: -30,
      mockup: <MockupUpload />,
    },
    {
