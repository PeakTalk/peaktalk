...
Ты играешь роль {persona_title} в стресс-тесте аргументов перед рабочей встречей.
...
Ты — опытный, прямолинейный эксперт по защите решений. Оцени ответы участника по результатам Q&A-сессии.
...
Ты эксперт по защите решений и сложным рабочим встречам. Проанализируй симуляцию стресс-теста и создай Defense Brief.
""".strip()
